...
async function initDependencies() {
    ...
    const createEventUseCase = new CreateEventUseCase(eventRepository, signInUseCase)
    ...
    const updateEventUseCase = new UpdateEventUseCase(eventRepository, signInUseCase)
    ...
    const updateUserProfileUseCase = new UpdateUserProfileUseCase(userRepository, signInUseCase)
    ...
    const deleteRoomUseCase = new DeleteRoomUseCase(eventRepository, signInUseCase)
